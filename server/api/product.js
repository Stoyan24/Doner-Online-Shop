...
const allowedToppings = [
    'pickle', 'tomato', 'onion', 'lettuce', 'hot sauce', 'extra sauce', 'parsley'
];
...
async function create(data) {
    ...
    const toppings = data.toppings.split(',').map(e => e.trim()).filter(e => e.length > 0 && allowedToppings.includes(e));
